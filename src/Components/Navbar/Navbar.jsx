...
export default function Navbar() {
  ...
  return (
    <div id="navFix" className="flex h-30 rounded-2xl mx-auto ">
      <Navbar_
        maxWidth="full"
        className="rounded-2xl backdrop-lg h-16 mt-5 shadow-xl ring-slate-200 ring-2 ring-offset-2"
      >
        <Box width={["100%"]}>
          <Flex
            h={16}
          ...
          >
            ...
            <Dropdown>
              ...
              <DropdownMenu
                className="z-10 inline-flex flex-col items-center justify-center  outline-none box-border text-small bg-content1 rounded-large w-full p-1 min-w-[200px]"
